...
export default function SubmissionStep() {
  ...
  const [submissionStatus, setSubmissionStatus] = useState<'ready' | 'submitting' | 'success' | 'error'>('ready')
    ...
    return (
      <div className="text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">Your vendor registration has been submitted for admin review.</p>
        </div>
        <div className="p-6 bg-blue-50 rounded-lg border border-blue-200">
          ...
          <div className="space-y-2 text-sm text-blue-800 text-left">
            ...
            <p>• Once approved, you'll get a <strong>20-day FREE premium trial</strong></p>
    ...
    <div className="space-y-6">
      ...
      <div className="p-6 bg-gray-50 rounded-lg space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <div className="space-y-1 text-gray-600">
              <p><strong>Package:</strong> {formData.selectedPackage?.charAt(0).toUpperCase() + formData.selectedPackage?.slice(1)}</p>
      ...
      <Alert className="border-green-200 bg-green-50">
        ...
        <AlertDescription className="text-green-800">
          <strong>Great news!</strong> Your registration fee includes a 20-day premium trial.
          No payment required until your trial period ends.
        </AlertDescription>
      </Alert>
