...
const KERALA_CITIES = [
  'Thiruvananthapuram', 'Kochi (Ernakulam)', 'Kozhikode (Calicut)', 'Thrissur', 'Kottayam',
  'Alappuzha (Alleppey)', 'Palakkad', 'Malappuram', 'Kannur', 'Kollam', 'Kasaragod',
  'Pathanamthitta', 'Wayanad', 'Idukki', 'Thodupuzha', 'Muvattupuzha', 'Perumbavoor',
  'Kothamangalam', 'Chalakudy', 'Irinjalakuda', 'Kodungallur', 'Guruvayur', 'Ottapalam',
  'Shoranur', 'Mannarkkad', 'Chittur', 'Ponnani', 'Tirur', 'Tanur', 'Perinthalmanna',
  'Manjeri', 'Kondotty', 'Payyanur', 'Taliparamba', 'Koyilandy', 'Vadakara', 'Kalpetta',
  'Mananthavady', 'Sulthan Bathery', 'Munnar', 'Devikulam', 'Kumily', 'Nedumkandam',
  'Cherthala', 'Kayamkulam', 'Mavelikkara', 'Changanassery', 'Pala', 'Ettumanoor',
  'Vaikom', 'Mundakayam', 'Punalur', 'Paravur', 'Karunagappally', 'Varkala', 'Attingal',
  'Nedumangad', 'Vithura', 'Neyyattinkara', 'Kattakkada', 'Adoor', 'Pandalam',
  'Mallappally', 'Thiruvalla', 'Ranni', 'Kozhencherry'
] as const
