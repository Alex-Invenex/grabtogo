...
const keralaLocations: Location[] = [
  ...
  },
  {
    ...
    district: 'Kottayam',
    state: 'Kerala',
    coordinates: { lat: 9.7333, lng: 76.6833 },
    popular: false,
    businessCount: 89,
  },
  {
    ...
    district: 'Kottayam',
    state: 'Kerala',
    coordinates: { lat: 9.45, lng: 76.55 },
    popular: false,
    businessCount: 67,
  },
  ...
  },
  {
    ...
    district: 'Ernakulam',
    state: 'Kerala',
    coordinates: { lat: 9.9654, lng: 76.2424 },
    popular: true,
    businessCount: 123,
  },
  {
    ...
    district: 'Ernakulam',
    state: 'Kerala',
    coordinates: { lat: 9.9705, lng: 76.2867 },
    popular: true,
    businessCount: 89,
  },
  {
    ...
    district: 'Ernakulam',
    state: 'Kerala',
    coordinates: { lat: 9.9797, lng: 76.5783 },
    popular: false,
    businessCount: 78,
  },
  ...
  },
  {
    ...
    district: 'Thrissur',
    state: 'Kerala',
    coordinates: { lat: 10.309, lng: 76.3348 },
    popular: false,
    businessCount: 56,
  },
  ...
  },
  {
    ...
    district: 'Thiruvananthapuram',
    state: 'Kerala',
    coordinates: { lat: 8.4, lng: 77.0833 },
    popular: false,
    businessCount: 45,
  },
  ...
  },
  {
    ...
    district: 'Kozhikode',
    state: 'Kerala',
    coordinates: { lat: 11.251, lng: 75.7682 },
    popular: true,
    businessCount: 87,
  },
  ...
  },
  {
    ...
    district: 'Wayanad',
    state: 'Kerala',
    coordinates: { lat: 11.6054, lng: 76.0849 },
    popular: true,
    businessCount: 78,
  },
  {
...
export function LocationPicker({
  ...
  React.useEffect(() => {
    if (searchQuery.trim()) {
      const filtered = keralaLocations.filter(
        (location) =>
  ...
  return (
    <div
      className={`bg-white rounded-2xl shadow-lg p-6 max-h-[500px] overflow-hidden flex flex-col ${className}`}
    >
      {/* Header */}
      <div className="mb-4">
        ...
        {filteredLocations.length === 0 && (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Try searching for a different area in Kerala
            </p>
          </div>
        )}
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <h5
                className={`font-medium truncate ${isSelected ? 'text-primary' : 'text-gray-900'}`}
              >
                {location.name}
              </h5>
              {location.popular && (
                <Badge className="bg-amber-100 text-amber-800 text-xs px-1.5 py-0.5">Popular</Badge>
              )}
            </div>
            ...
            <p className="text-xs text-gray-500">{location.businessCount} businesses nearby</p>
          </div>
        </div>
